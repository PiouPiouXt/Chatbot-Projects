...
//#region node_modules/supersimpledev/chatbot.js
var require_chatbot = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Chatbot = {
		defaultResponses: {
			"hello hi": `Hello! How can I help you?`,
			"how are you": `I'm doing great! How can I help you?`,
			"flip a coin": function() {
				if (Math.random() < .5) return "Sure! You got heads";
				else return "Sure! You got tails";
			},
		...
		getResponse: function(message) {
			...
			if (ratings[bestMatchIndex].rating <= .3) return this.unsuccessfulResponse;
	...
	function uuidPolyfill() {
		return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(char) {
			...
			return (char === "x" ? randomNumber : randomNumber & 3 | 8).toString(16);
		});
	}
	(function(root, factory) {
		if (typeof define === "function" && define.amd) define([], factory);
			...
			if (typeof root.crypto === "undefined") try {
				root.crypto = {};
			} catch (e) {}
			if (root.crypto && typeof root.crypto.randomUUID !== "function") try {
...
//#endregion
//#region node_modules/supersimpledev/index.js
var require_supersimpledev = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	if (typeof window !== "undefined") {
		if (typeof window.crypto === "undefined") try {
			window.crypto = {};
		} catch (e) {}
